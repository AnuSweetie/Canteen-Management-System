...
<h4> Transaction ID:<input type="text">
Customer Name:<input type="text"><hr>
<h4>Date:<input type="text">
 Time:<input type="text"><hr>
<h4> Food Name:<input type="text">
 Quantity:<input type="text"><hr>
<h4> Total Amount:<input type="text">
<button type="submit" class="submit">Add</button></font>
</form>
</body>
</html>
